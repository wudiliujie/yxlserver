...
const (
	...
	Center_Rpc_GetBestModule      = "GetBestModule"      //当玩家下线
	Center_Rpc_PlayerLoginSuccess = "PlayerLoginSuccess" //当玩家下线

	Center_Rpc_OnPlayerChangeModule = "OnPlayerChangeModule" //playerManage module发生变化
