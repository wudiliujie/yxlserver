...
func (m *C2SLogin) GetId() uint16  { return uint16(PCKID_C2SLogin) }
...
func (m *S2CLogin) GetId() uint16  { return uint16(PCKID_S2CLogin) }
...
func (m *S2CRoleInfo) GetId() uint16  { return uint16(PCKID_S2CRoleInfo) }
